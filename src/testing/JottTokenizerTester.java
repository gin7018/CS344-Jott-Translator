 ...
 *
 * This expects the test cases to be in the directory testing.tokenizerTestCases in the
...
public class JottTokenizerTester {
    ...
    private void createTestCases(){
        ...
        String filename = "testing/tokenizerTestCases/number.jott";
        ...
        String mathOps = "+-*/";
        filename = "testing/tokenizerTestCases/mathOpsTest.jott";
        ...
        filename = "testing/tokenizerTestCases/singleCharTokens.jott";
        ...
        filename = "testing/tokenizerTestCases/relOpsTokens.jott";
        ...
        filename = "testing/tokenizerTestCases/idKeywords.jott";
        ...
        filename = "testing/tokenizerTestCases/strings.jott";
        ...
        filename = "testing/tokenizerTestCases/phase1ErrorExample.jott";
